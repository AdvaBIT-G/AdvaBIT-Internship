...
CHECKPOINT_PATH = "/home/gmartinez/AdvaBIT-Internship/flower_phenotyping/models/autoencoder/checkpoint_epoch_180.pth"
...
RUN_TAG = "20260805"  # to save the different figures with a unique name
BATCH_SIZE = 16
TSNE_PERPLEXITY = 30
